/**
 * Sample analysis payload for frontend UI work without calling the LLM.
 * Toggle USE_SAMPLE_ANALYSIS in app.js to enable/disable.
 */
...
function fetchSampleAnalysis(delayMs = 10000) {
  return new Promise((resolve) => {
    window.setTimeout(() => resolve(SAMPLE_ANALYSIS), delayMs);
  });
}

window.SampleAnalysis = { fetch: fetchSampleAnalysis, data: SAMPLE_ANALYSIS };
