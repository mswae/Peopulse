...
4. Keep the summaries concise but insightful. Avoid using idioms that can lengthen the output. 
5. CRITICAL: Output ONLY valid JSON. No markdown formatting blocks, no greetings. 

# Output Requirements
{{
    "top_praises": ["1-3 full sentences about the top praises"],
    "top_complaints": ["1-3 full sentences about the top complaints"],
    "overview": ["1-3 full sentences of summary for the positive, negative, and actionable recommendations."]
}}